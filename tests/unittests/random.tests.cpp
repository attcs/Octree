  ...
  */
  ...
  private:
    ...
    void PointND_RangeSearch(size_t pointsNo, size_t boxesNo, TScalar rMin, TScalar rMax)
    {
      ...
      auto const treeContainer = OrthoTree::OrthoTreePointManagedND<DIMENSION_NO, TScalar>(points);
    ...
    void BoxND_RangeSearch(size_t boxNo, size_t searchboxNo, TScalar rMin, TScalar rMax)
    {
      ...
      auto const treeContainer = OrthoTree::OrthoTreeBoxManagedND<DIMENSION_NO, IS_LOOSE_TREE, TScalar>(entityBoxes);
