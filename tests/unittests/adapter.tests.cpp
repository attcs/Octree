...
namespace AdaptorTest
{
  ...
  TEST_CLASS(PointTest){ public: TEST_METHOD(Empty){ auto const tree = QuadtreePointCustom(vector<MyPoint2D>{}, 2);
...
{
  TEST_CLASS(EigenTest){ public: TEST_METHOD(PointGeneral3D){ using EntityID = Eigen::OctreePoint3d::EntityID;
...
namespace XYZAdaptorTest
{
  ...
  TEST_CLASS(XYZTest){ public: TEST_METHOD(PointGeneral3D){ using EntityID = XYZ::OctreePoint::EntityID;
...
namespace UnrealAdaptorTest
{
  ...
  TEST_CLASS(UnrealTest){ public: TEST_METHOD(PointGeneral3D){ using EntityID = FOctreePoint::EntityID;
...
namespace BoostAdaptorTest
{
  ...
  TEST_CLASS(BoostTest){ public: TEST_METHOD(PointGeneral3D){ using point_t = model::pointNd_t<3, double>;
